      ...
      <div id="ListSelect" class="col-4">
  	  ...
  	  <div id="LoG">
  		<c:forEach var="product" items="${product_list}">  		   
		   <div class="items">
		   <img src="${product.product_listImg}" style="width:200px; height:150px;" onclick="javascript:location.href='detailview.do?product_category=<%= product_category %>&product_idx=${product.product_idx}'">
