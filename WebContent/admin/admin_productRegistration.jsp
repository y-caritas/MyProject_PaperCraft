...
<body>
	...
	<div style="margin-left: 30px;">
      <form id="fromsubmit" name="adminProduct" action="productRegister.do" onsubmit="return confirm();" method="POST" enctype="multipart/form-data">
      ...
      <input style="width:830px; " name="product_note" class="form-control input-group"  type="text" placeholder="25자 이내로 소개글을 입력하세요.">
      <div>
        <b>상품이미지</b>
      </div>
      <div class="file_input">
        <table class="input-group">
		  ...
		  <tr>
            ...
            <td>
              <input name="product_introduction" type="text" readonly="readonly" title="File Route" id="file_route3" value="">
      ...
      <textarea name="product_memo"  cols="120" rows="6"></textarea>      
